...
public:
    ...
    virtual rocksdb::Status CommitBatch(Context &ctx, rocksdb::WriteBatch *updates);

    virtual rocksdb::Status
    CommitBatch(Context &ctx, const rocksdb::WriteOptions &options, rocksdb::WriteBatch *updates);
    ...
    virtual int raw_get(Context &ctx, const Bytes &key, rocksdb::ColumnFamilyHandle *column_family, std::string *val);
    ...
    virtual int
    restore(Context &ctx, const Bytes &key, int64_t expire, const Bytes &data, bool replace, std::string *res);
    ...
    virtual int hmget(Context &ctx, const Bytes &name, const std::vector<std::string> &reqKeys,
                      std::map<std::string, std::string> &val);

    virtual int hgetall(Context &ctx, const Bytes &name, std::vector<std::string> &list,
...
//	virtual HIterator* hscan(Context &ctx, const Bytes &name,const Bytes &start, const Bytes &end, uint64_t limit);
    virtual int hscan(Context &ctx, const Bytes &name, const Bytes &cursor, const std::string &pattern, uint64_t limit,
    ...
    virtual int sscan(Context &ctx, const Bytes &name, const Bytes &cursor, const std::string &pattern, uint64_t limit,
                      std::vector<std::string> &resp);

    /* zset */
    virtual int
    multi_zset(Context &ctx, const Bytes &name, const std::map<Bytes, Bytes> &sortedSet, int flags, int64_t *count);
    ...
    int zremrangebyscore(Context &ctx, const Bytes &name, const Bytes &score_start, const Bytes &score_end, bool remove,
                         int64_t *count);
    ...
    virtual int zrange(Context &ctx, const Bytes &name, const Bytes &begin, const Bytes &limit, bool withscore,
                       std::vector<std::string> &key_score);

    virtual int zrrange(Context &ctx, const Bytes &name, const Bytes &begin, const Bytes &limit, bool withscore,
                        std::vector<std::string> &key_score);

    virtual int zrangebyscore(Context &ctx, const Bytes &name, const Bytes &start_score, const Bytes &end_score,
                              std::vector<std::string> &key_score,
                              int withscores, long offset, long limit);

    virtual int zrevrangebyscore(Context &ctx, const Bytes &name, const Bytes &start_score, const Bytes &end_score,
                                 std::vector<std::string> &key_score,
                                 int withscores, long offset, long limit);
     ...
     */
    virtual int zscan(Context &ctx, const Bytes &name, const Bytes &cursor, const std::string &pattern, uint64_t limit,
                      std::vector<std::string> &resp);

    virtual int
    zlexcount(Context &ctx, const Bytes &name, const Bytes &key_start, const Bytes &key_end, int64_t *count);

    virtual int zrangebylex(Context &ctx, const Bytes &name, const Bytes &key_start, const Bytes &key_end,
                            std::vector<std::string> &keys,
                            long offset, long limit);

    virtual int zrevrangebylex(Context &ctx, const Bytes &name, const Bytes &key_start, const Bytes &key_end,
                               std::vector<std::string> &keys,
                               long offset, long limit);

    virtual int
    zremrangebylex(Context &ctx, const Bytes &name, const Bytes &key_start, const Bytes &key_end, int64_t *count);


    /* eset */
    virtual int eget(Context &ctx, const Bytes &key, int64_t *ts);

    virtual int eset_one(Context &ctx, const Bytes &key, rocksdb::WriteBatch &batch, int64_t ts_ms);

    virtual int edel_one(Context &ctx, const Bytes &key, rocksdb::WriteBatch &batch);
...
private:
    ...
    int SetGeneric(Context &ctx, const Bytes &key, rocksdb::WriteBatch &batch, const Bytes &val, int flags,
                   int64_t expire_ms, int *added);

    int GetKvMetaVal(const std::string &meta_key, KvMetaVal &kv);

    int del_key_internal(Context &ctx, const Bytes &key, rocksdb::WriteBatch &batch);

    int mark_key_deleted(Context &ctx, const Bytes &key, rocksdb::WriteBatch &batch, const std::string &meta_key,
                         std::string &meta_val);
    ...
    HIterator *
    hscan_internal(Context &ctx, const Bytes &name, uint16_t version, const rocksdb::Snapshot *snapshot = nullptr);

    int incr_hsize(Context &ctx, const Bytes &name, rocksdb::WriteBatch &batch, const std::string &size_key,
    ...
    SIterator *
    sscan_internal(Context &ctx, const Bytes &name, uint16_t version, const rocksdb::Snapshot *snapshot = nullptr);

    int incr_ssize(Context &ctx, const Bytes &key, rocksdb::WriteBatch &batch, const SetMetaVal &sv,
    ...
    int doListPop(Context &ctx, const Bytes &key, rocksdb::WriteBatch &batch, ListMetaVal &lv, std::string &meta_key,
                  LIST_POSITION lp, std::pair<std::string, bool> &val);

    template<typename T>
    int doListPush(Context &ctx, const Bytes &key, rocksdb::WriteBatch &batch, const std::vector<T> &val, int offset,
    ...
    int incr_zsize(Context &ctx, const Bytes &name, rocksdb::WriteBatch &batch, const ZSetMetaVal &zv, int64_t incr);
    ...
    int zrangeGeneric(Context &ctx, const Bytes &name, const Bytes &begin, const Bytes &limit, bool withscore,
                      std::vector<string> &key_score, int reverse);

    int genericZrangebyscore(Context &ctx, const Bytes &name, const Bytes &start_score, const Bytes &end_score,
                             std::vector<std::string> &key_score,
                             int withscores, long offset, long limit, int reverse);

    int genericZrangebylex(Context &ctx, const Bytes &name, const Bytes &key_start, const Bytes &key_end,
    ...
    template<typename T>
    int quickList(Context &ctx, const Bytes &key, const std::string &meta_key, const std::string &meta_val, T lambda);
