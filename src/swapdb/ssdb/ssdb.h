...
public:
    ...
    virtual int
    restore(Context &ctx, const Bytes &key, int64_t expire, const Bytes &data, bool replace, std::string *res) = 0;
    ...
    virtual int
    getrange(Context &ctx, const Bytes &key, int64_t start, int64_t end, std::pair<std::string, bool> &res) = 0;
    ...
    virtual int
    hincrbyfloat(Context &ctx, const Bytes &name, const Bytes &key, long double by, long double *new_val) = 0;
    ...
    /* zset */
    virtual int
    multi_zset(Context &ctx, const Bytes &name, const std::map<Bytes, Bytes> &sortedSet, int flags, int64_t *num) = 0;
    ...
    virtual int
    zlexcount(Context &ctx, const Bytes &name, const Bytes &key_start, const Bytes &key_end, int64_t *count) = 0;
    ...
    virtual int
    zremrangebylex(Context &ctx, const Bytes &name, const Bytes &key_start, const Bytes &key_end, int64_t *count) = 0;
